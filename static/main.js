		...
		if (shouldStart) {
			...
			if (win1 == null || win2 == null || win3 == null) {
				...
				if (win1 == null) {
					...
					.to({x : $('#track_bg').width() * 0.9 }, 100 , createjs.Ease.easeOutExpo)
